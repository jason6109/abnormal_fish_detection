...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def init_gui(self):
        ...
        self.openVideoBtn = QtWidgets.QPushButton('video')
    ...
    def start_video(self):
        if self.timer.isActive():
            self.timer.stop()
        fileName, fileType = QtWidgets.QFileDialog.getOpenFileName(self, "video", filter='*.mp4')
    ...
    def load_model(self):
        fileName, fileType = QtWidgets.QFileDialog.getOpenFileName(self, "模型權重", filter='*.pt')
